apex_namespaces = {
    ...
    "Schema" : ["DescribeColorResult", "ChildRelationship", "SoapType", "DescribeTabResult", "DataCategory", "DescribeTabSetResult", "DescribeDataCategoryGroupResult", "DescribeSObjectResult", "DescribeDataCategoryGroupStructureResult", "DescribeIconResult", "FieldSet", "PicklistEntry", "SObjectField", "RecordTypeInfo", "FieldSetMember", "SObjectType", "DataCategoryGroupSobjectTypePair", "DescribeFieldResult", "DisplayType"],
    "dom" : ["XmlNode", "XmlNodeType", "Document"],
    ...
    "QuickAction" : ["QuickActionRequest", "DescribeAvailableQuickActionResult", "DescribeLayoutRow", "DescribeLayoutComponent", "QuickActionTemplateResult", "Control", "ReportChartComponent", "VisualforcePage", "DescribeLayoutItem", "EmptySpace", "DescribeQuickActionResult", "ExpandedLookup", "Field", "SControl", "DescribeQuickActionDefaultValue", "Separator", "QuickActionResult", "DescribeLayoutSection"],
    "Messaging" : ["PushNotification", "InboundEnvelope", "SingleEmailMessage", "EmailFileAttachment", "Header", "EmailAttachment", "Email", "PushNotificationPayload", "InboundEmailHandler", "EmailToSalesforceHandler", "BinaryAttachment", "TextAttachment", "InboundEmailResult", "InboundEmail", "SendEmailError", "SendEmailResult", "MassEmailMessage"],
    "Social" : ["InboundSocialPostHandler", "InboundSocialPostResult"],
    "Process" : ["SparkPlugDescribeResult", "Plugin", "PluginDescribeResult", "ParameterType", "SparkPlugParameter", "PluginRequest", "OutputParameter", "InputParameter", "SparkPlugApi", "PluginResult"],
    "Approval" : ["ProcessSubmitRequest", "ProcessRequest", "ProcessWorkitemRequest", "ProcessResult"],
    "reports" : ["ReportManager", "ReportCurrency", "ReportInstance", "ReportDataCell", "GroupingValue", "ReportDetailRow", "ReportResults", "DetailColumn", "ReportDescribeResult", "ReportFilter", "GroupingColumn", "DateGranularity", "ReportType", "ReportFactWithDetails", "ReportRunException", "GroupingInfo", "FilterValue", "InstanceAccessException", "ReportInstanceAttributes", "ReportFormat", "InvalidReportMetadataException", "Dimension", "MetadataException", "ReportTypeColumnCategory", "FilterOperator", "FeatureNotSupportedException", "ReportMetadata", "UnsupportedOperationException", "ColumnDataType", "ReportFactWithSummaries", "ColumnSortOrder", "InvalidSnapshotDateException", "ReportTypeMetadata", "AggregateColumn", "SummaryValue", "ReportFact", "ReportExtendedMetadata", "InvalidFilterException", "ReportTypeColumn"],
    "Flow" : ["Interview"],
    "predictive" : ["PredictiveException", "WordPresenceReason", "FieldTreatment", "NumberFieldTreatment", "PredictedResult", "QueryException", "ObjectTreatment", "ReasonType", "RelatedField", "ObjectRefreshStatus", "DoublePredictedField", "RelatedResult", "PredictedField", "SimilarResult", "OmittedFieldTreatment", "TimeDeltaFieldTreatment", "BasePredictedFieldImpl", "StringPredictedField", "ValueReason", "BooleanPredictedField", "ItemPresenceReason", "ObjectAnalysis", "DatePredictedField", "PresenceReason", "PresenceFlagFieldTreatment", "SetFieldTreatment", "SimilarRecord", "FieldTreatmentType", "CategoricalFieldTreatment", "AnalysisException", "TextFieldTreatment", "Reason", "Row", "PredictedFieldType", "ObjectAnalysisService", "ObjectRefreshState"],
    "workflow" : ["ActionDml", "Action", "Context"],
    "ConnectApi" : ["FeedFavorite", "CommentInput", "ChatterGroupPage", "Zone", "Chatter", "AbstractRecordView", "Comment", "FeedItemInput", "MoreChangesSegment", "MessageSegment", "QuestionAttachmentInput", "GroupEmailFrequency", "ChatterGroupSummary", "ChatterFeeds", "WorkflowProcessStatus", "BinaryInput", "UserSummary", "ChatterConversationPage", "ChatterConversation", "MentionValidations", "FieldChangeSegment", "ChatterLike", "FeedSortOrder", "CommentType", "RecordDetails", "FileSummary", "ChatterGroup", "CanvasAttachmentInput", "RecordField", "NotFoundException", "UserChatterSettings", "UnreadConversationCount", "ChatterGroups", "FeedModifiedInfo", "AbstractRecordField", "Community", "FeedDirectory", "TextSegment", "TopicSort", "ChatterConversationSummary", "LinkSegment", "MentionSegment", "CommunityStatus", "ZoneSearchResultType", "ChatterFavorites", "RecordSummary", "CaseActorType", "FeedFavoriteType", "UserProfileTabType", "MessageSegmentType", "Photo", "Zones", "ApprovalPostTemplateField", "MentionCompletion", "GroupInformation", "OrganizationSettings", "Feed", "NewFileAttachmentInput", "SortOrder", "ChatterGroupInput", "TopicPage", "Topics", "PercentRecordField", "RecordFieldType", "Communities", "CommunityPage", "FeedDirectoryItem", "UserType", "ChatterUsers", "RecordColumnOrder", "File", "ContentAttachment", "GroupRecordPage", "UserInput", "PollAttachmentInput", "UserProfileTab", "FieldChangeValueType", "GroupArchiveStatus", "PicklistRecordField", "MessageBodyInput", "ReferenceRecordField", "PhoneNumber", "HashtagSegmentInput", "FeedItem", "LinkAttachmentInput", "Mentions", "User", "BlankRecordField", "FeedItemTopicPage", "FieldChangeNameSegment", "TimeZone", "CaseCommentEventType", "GroupVisibilityType", "BasicTemplateAttachment", "ReferenceWithDateRecordField", "TopicInput", "FeedType", "Features", "GroupMembershipRequest", "ZoneShowIn", "UserPage", "GroupInformationInput", "UserCapabilities", "EntityLinkSegment", "ZoneSearchResult", "UnauthenticatedUser", "ChatterLikePage", "RecordSnapshotAttachment", "GroupMembershipRequestStatus", "CommunityModeration", "CompoundRecordField", "GroupMemberPage", "MessageBody", "ZoneSearchPage", "MentionCompletionType", "ZonePage", "MentionCompletionPage", "ChatterMessages", "DateRecordField", "ChatterGroupDetail", "GlobalInfluence", "ConnectApiException", "Records", "EmailAddress", "TrackedChangeItem", "EmailMessage", "LinkSegmentInput", "TopicSuggestionPage", "CanvasTemplateAttachment", "ApprovalAttachment", "Address", "Topic", "Actor", "MentionSegmentInput", "UserDetail", "TopicSuggestion", "CurrencyRecordField", "ResourceLinkSegment", "Icon", "GroupMember", "FeedFavorites", "HashtagSegment", "Motif", "RateLimitException", "CommentPage", "Subscription", "FeedItemPage", "MessageSegmentInput", "GroupMembershipType", "ChatterMessagePage", "Organization", "TextSegmentInput", "AbstractMessageBody", "FollowerPage", "QuestionAttachment", "CommunityFlagVisibility", "ChatterMessage", "TrackedChangeAttachment", "EmailMessageDirection", "FeedItemAttachment", "RecordSummaryList", "Reference", "FileSharingType", "DashboardComponentAttachment", "FieldChangeValueSegment", "UserGroupPage", "UserSettings", "UserProfiles", "ActorWithId", "FeedItemVisibilityType", "LinkAttachment", "CaseComment", "LabeledRecordField", "FeedBody", "ModerationFlags", "RecordViewSection", "GroupChatterSettings", "ComplexSegment", "RecordView", "FeedPollChoice", "FeedItemType", "FeedDensity", "MentionValidation", "GroupMembershipRequests", "FollowingPage", "FeedPoll", "FilePublishStatus", "UserProfile", "GroupRecord", "MentionValidationStatus", "FeedItemAttachmentType", "ChatterActivity", "ClientInfo", "FeedItemAttachmentInput", "ContentAttachmentInput", "FollowingCounts", "PhotoInput"],
    "Support" : ["EmailTemplateSelector", "EmailToCaseHandler", "MilestoneTriggerTimeCalculator"],
    "Site" : ["UrlRewriter"]
}
...
apex_completions = {
    ...
    "string": {
        ...
        "methods": {
            ...
            "equals(String other)\tBoolean": "equals(${1:String other})$0",
    ...
    "messagebodyinput": {
        ...
        "methods": {
            "equals(Object obj)\tBoolean": "equals(${1:Object obj})$0",
            "hashCode()\tInteger": "hashCode()$0",
            "convertToJavaObject(java:common.api.AppVersion currentVersion)\tjava:java.lang.Object": "convertToJavaObject(${1:java:common.api.AppVersion currentVersion})$0",
            "toString()\tString": "toString()$0"
        },
        "constructors": {
    ...
    "applauncherapexcontroller": {
        ...
        "constructors": {
            "AppLauncherApexController()\t": "AppLauncherApexController()$0"
        }
    },
    "sobjectexception": {
    ...
    "abstractbundlecapability": {
        "name": "AbstractBundleCapability",
        "namespace": "ConnectApi",
        "properties": {
            "bundleType": "bundleType$0",
            "feedElements": "feedElements$0",
    ...
    "messagesegmentinput": {
        ...
        "methods": {
            "equals(Object obj)\tBoolean": "equals(${1:Object obj})$0",
            "hashCode()\tInteger": "hashCode()$0",
            "convertToJavaObject(java:common.api.AppVersion param1)\tjava:java.lang.Object": "convertToJavaObject(${1:java:common.api.AppVersion param1})$0",
            "toString()\tString": "toString()$0"
        },
        "constructors": {}
    },
    ...
    "docscontroller": {
        ...
        "methods": {},
        "constructors": {
            "DocsController()\t": "DocsController()$0"
        }
    },
    "jsonexception": {
        "name": "JSONException",
    ...
    "badgelimittype": {
        ...
        "methods": {
            "equals(Object obj)\tBoolean": "equals(${1:Object obj})$0",
            "hashCode()\tInteger": "hashCode()$0",
            "values()\tLIST<ConnectApi.BadgeLimitType>": "values()$0"
        },
        "constructors": {}
    },
    "comparable": {
